...
// Mặc định Arduino Uno là 32. Nhưng trên ESP32 bộ đệm I2C có thể lên tới 128 byte.
// Việc tăng lên 128 sẽ giúp quá trình nạp 90KB firmware cho VL53L5CX giảm từ 2.5s xuống chỉ còn 0.6s!
const uint8_t I2C_BUFFER_SIZE = 128;
