...
volatile float servo_deg[6] = {96.43f, 90.0f, 35.0f, 65.0f, 90, 0.0f};
...
/* Initial values match servo init: q0=96.43 deg, q1=35 deg, q2=0 deg, q3=0 deg, q4=60 deg.
 * q5=0 deg maps to 0 deg on the left joint-6 servo. */
...
//      }
        ...
        servo_deg[5] = ARM_Proto_X100ToDeg(q_new[5]);
