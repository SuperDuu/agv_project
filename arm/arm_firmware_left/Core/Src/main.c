...
volatile float servo_deg[6] = {96.43f, 90.0f, 35.0f, 65.0f, 90, 90.0f};
 ...
 * q5=0° maps to 90° on the reversed 0..90° left joint-6 servo. */
...
//      }
        ...
        servo_deg[5] = 90.0f - ARM_Proto_X100ToDeg(q_new[5]);
...
//                  }
                  ...
                  servo_deg[5] = 90.0f - (float)q[5] / 100.0f;
                } else {
                  dbg_rx_len++;
                }
              } else {
