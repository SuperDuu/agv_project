public class TestHoverJoint2 {
    public static void main(String[] args) {
        double lowChairHeight = 102.4;
        
        System.out.println("Testing different Joint 2 angles for lowHoverRight:");
        for (double hoverQ2 = 30.0; hoverQ2 <= 75.0; hoverQ2 += 5.0) {
            double[] qStart = { 0.0, -90.0, 86.0, -95.0, 57.0, 60.0 };
            double[] qEnd = { 0.0, hoverQ2, 86.0, -95.0, 57.0, 60.0 };
            ...
            System.out.printf("hoverQ2=%.1f -> Min TCP Z = %.2f (at Y=%.2f)\n", hoverQ2, minZ, minZ_Y);
        }
    }
