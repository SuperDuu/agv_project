public class TestHomeToReady {
    public static void main(String[] args) {
        double[] qStart = { 0.0, 0.0, 20.0, -35.0, 0.0, 0.0 }; // Fixed home pose
        double[] qEnd = { 0.0, -90.0, 120.0, -90.0, 40.0, 10.0 }; // Folded ready pose
        ...
        System.out.println("Checking home to ready path:");
        boolean allOk = true;
        ...
        if (allOk) {
            System.out.println("SUCCESS! Home to ready path is completely collision-free!");
        } else {
