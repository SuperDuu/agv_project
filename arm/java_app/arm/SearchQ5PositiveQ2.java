...
public class SearchQ5PositiveQ2 {
    public static void main(String[] args) {
        System.out.println("Scanning workspace for Q5 = ±90, Q6 ∈ [-60, 60], full Q2:");
        ...
        for (double q5 : q5Values) {
            for (double q2 = -90.0; q2 <= 90.0; q2 += 3.0) {
                for (double q3 = 20.0; q3 <= 165.0; q3 += 3.0) {
                    for (double q4 = -95.0; q4 <= 20.0; q4 += 3.0) {
                        ...
                        for (double q6 = -60.0; q6 <= 60.0; q6 += 3.0) {
