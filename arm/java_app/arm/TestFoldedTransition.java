public class TestFoldedTransition {
    public static void main(String[] args) {
        double[] qStart = { 0.0, -90.0, 120.0, -90.0, 40.0, 10.0 }; // Folded transfer pose
        double[] qEnd = { 0.0, 35.0, 48.0, -17.0, 40.0, 10.0 }; // Low hover pose
        ...
        System.out.println("Checking folded transition path:");
        boolean allOk = true;
        ...
        if (allOk) {
            System.out.println("SUCCESS! Folded transition path is completely collision-free!");
        } else {
