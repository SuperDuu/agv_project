public class TestDirectHoverTransition {
    public static void main(String[] args) {
        double[] qStart = { 0.0, 35.0, 48.0, -17.0, 40.0, 10.0 };
        double[] qEnd = { 0.0, -66.0, 42.0, -19.0, -35.0, -45.0 };
        ...
        System.out.println("Checking direct hover-to-hover path:");
        boolean allOk = true;
        for (int step = 0; step <= 8; step++) {
            ...
            System.out.printf("step %d: q2=%.1f -> TCP=(%.2f, %.2f, %.2f) | Joint6_Z=%.2f\n",
                    step, q[1], pt7[0], pt7[1], pt7[2], pt6[2]);
        ...
        if (allOk) {
            System.out.println("SUCCESS! Direct hover-to-hover path is completely collision-free!");
        } else {
