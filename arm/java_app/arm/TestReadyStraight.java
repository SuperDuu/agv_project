public class TestReadyStraight {
    public static void main(String[] args) {
        double[] qStart = { 0.0, 0.0, 20.0, -35.0, 0.0, 0.0 }; // Home
        double[] qEnd = { 0.0, -90.0, 120.0, -90.0, 0.0, 0.0 }; // Straight ready pose
        ...
        System.out.println("Checking home to straight ready path:");
        boolean allOk = true;
        ...
        if (allOk) {
            System.out.println("SUCCESS! Home to straight ready path is completely collision-free!");
        } else {
