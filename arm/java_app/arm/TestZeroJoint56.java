public class TestZeroJoint56 {
    public static void main(String[] args) {
        double[][] testConfigs = {
            { 0.0, 20.0, 48.0, -17.0, 0.0, 0.0 },
            { 0.0, -64.0, 42.0, -19.0, 0.0, 0.0 },
            { 0.0, 30.0, 86.0, -95.0, 0.0, 0.0 },
            { 0.0, -90.0, 137.0, -83.0, 0.0, 0.0 }
        };

        for (int i = 0; i < testConfigs.length; i++) {
            System.out.printf("Config %d:\n", i+1);
            checkCrossbar(testConfigs[i]);
        }
    }
