public class SearchHorizontalByHeight {
    public static void main(String[] args) {
        System.out.println("Scanning workspace for horizontal gripper configurations with Z in [75.0, 115.0]:");
        int count = 0;
                ...
                for (double q4 = -95.0; q4 <= -15.0; q4 += 2.0) {
                    for (double q5 = -90.0; q5 <= 90.0; q5 += 5.0) {
                        for (double q6 = -45.0; q6 <= 45.0; q6 += 5.0) {
                            ...
                            if (tcp[2] >= 75.0 && tcp[2] <= 115.0 && tcp[0] >= 35.0) {
