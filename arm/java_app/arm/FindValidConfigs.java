public class FindValidConfigs {
    public static void main(String[] args) {
        System.out.println("Searching for Low Pick configs (Z = 85.0 cm, Q1 = 0.0):");
        search(85.0, 30.0, 60.0); // Search for Joint 2 around 30 to 60

        System.out.println("\nSearching for High Place configs (Z = 105.0 cm, Q1 = 0.0):");
        search(105.0, -90.0, -30.0); // Search for Joint 2 around -90 to -30
    }

    private static void search(double targetZ, double q2Min, double q2Max) {
        double sharedQ1 = 0.0;
        int count = 0;
        for (double q2 = q2Min; q2 <= q2Max; q2 += 2.0) {
