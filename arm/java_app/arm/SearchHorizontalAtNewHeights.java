public class SearchHorizontalAtNewHeights {
    public static void main(String[] args) {
        System.out.println("Searching for Low Pick configs (Z = 123.0, Q1 = 0.0):");
        search(123.0, 38.0);

        System.out.println("\nSearching for High Place configs (Z = 135.0, Q1 = 0.0):");
        search(135.0, 42.0);
    }

    private static void search(double targetZ, double minX) {
        double sharedQ1 = 0.0;
        int count = 0;
