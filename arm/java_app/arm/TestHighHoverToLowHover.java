public class TestHighHoverToLowHover {
    public static void main(String[] args) {
        double[] qStart = { 0.0, -90.0, 139.0, -95.0, 0.0, 30.0 };
        double[] qEnd = { 0.0, 45.0, 86.0, -95.0, 57.0, 60.0 };
        
        System.out.println("HighHover to LowHover path:");
        for (int step = 0; step <= 8; step++) {
            ...
            System.out.printf("step %d: q2=%.1f q3=%.1f -> TCP=(%.2f, %.2f, %.2f) | Joint6_Z=%.2f\n",
                    step, q[1], q[2], pts[7][0], pts[7][1], pts[7][2], pts[6][2]);
        }
    }
