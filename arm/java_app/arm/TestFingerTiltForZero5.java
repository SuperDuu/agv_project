public class TestFingerTiltForZero5 {
    public static void main(String[] args) {
        double[] q = { 0.0, -90.0, 137.0, -83.0, 0.0, 30.0 }; // Original highPlaceRight
        System.out.println("Config 1 (original highPlaceRight):");
        check(q);

        double[] q2 = { 0.0, 20.0, 48.0, -17.0, 0.0, 31.0 }; // lowPickRight with q5=0, q6=31
        System.out.println("\nConfig 2 (lowPickRight with q5=0, q6=31):");
        check(q2);
    }
