public class SearchHorizontalAnywhere {
    public static void main(String[] args) {
        System.out.println("Scanning workspace for horizontal gripper configurations:");
        int count = 0;
        // Large step size to scan quickly
                    ...
                    for (double q5 = -90.0; q5 <= 90.0; q5 += 10.0) {
                        for (double q6 = -45.0; q6 <= 45.0; q6 += 10.0) {
                            ...
                            if (tcp[0] >= 30.0) { // Keep reach reasonable
                                ...
                                if (Math.abs(fingerTilt) <= 5.0 && Math.abs(crossbarTilt) <= 5.0) {
