public class TestHomeToLowHover {
    public static void main(String[] args) {
        double[] qStart = { 0.0, 0.0, 20.0, -35.0, 0.0, 0.0 }; // Home
        double[] qEnd = { 0.0, 35.0, 48.0, -17.0, 40.0, 10.0 }; // Low hover
        ...
        System.out.println("Checking home to low hover path:");
        boolean allOk = true;
        ...
        if (allOk) {
            System.out.println("SUCCESS! Home to low hover path is completely collision-free!");
        } else {
