public class PrintLowHoverPick {
    public static void main(String[] args) {
        double[] lowPickRight = { 0.0, 30.0, 86.0, -95.0, 57.0, 60.0 };
        double[] lowHoverRight = { 0.0, 45.0, 86.0, -95.0, 57.0, 60.0 };
        
        double[][] ptsPick = computeAllJoints3DForAngles(lowPickRight, true);
        double[][] ptsHover = computeAllJoints3DForAngles(lowHoverRight, true);
        
        System.out.printf("Pick TCP: (%.2f, %.2f, %.2f)\n", ptsPick[7][0], ptsPick[7][1], ptsPick[7][2]);
        System.out.printf("Hover TCP: (%.2f, %.2f, %.2f)\n", ptsHover[7][0], ptsHover[7][1], ptsHover[7][2]);
    }
