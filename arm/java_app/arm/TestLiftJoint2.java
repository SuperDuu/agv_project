public class TestLiftJoint2 {
    public static void main(String[] args) {
        // New high place: [0.0, -90.0, 44.0, -17.0, 0.0, -52.0]
        for (double q2 = -90.0; q2 <= -84.0; q2 += 1.0) {
            double[] q = { 0.0, q2, 44.0, -17.0, 0.0, -52.0 };
            ...
            System.out.printf("  q2 = %.1f -> TCP=(%.2f, %.2f, %.2f) | fingerTilt=%.2f, crossbarTilt=%.2f\n",
                    q2, T[0][3], T[1][3], T[2][3], fingerTilt, crossbarTilt);
        }
    }
