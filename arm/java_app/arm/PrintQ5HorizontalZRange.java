...
public class PrintQ5HorizontalZRange {
    public static void main(String[] args) {
                    ...
                    for (double q5 : new double[] { -90.0, 90.0 }) {
                        for (double q6 = -60.0; q6 <= 60.0; q6 += 2.0) {
                            ...
                            if (Math.abs(fingerTilt) <= 10.0 && Math.abs(crossbarTilt) <= 10.0) {
                                ...
                                if (count < 20 && Math.abs(z - 118.0) < 5.0) {
                                    System.out.printf("  Near 118: q=[0.0, %.1f, %.1f, %.1f, %.1f, %.1f] TCP=(%.2f, %.2f, %.2f) fingerTilt=%.2f, crossbarTilt=%.2f\n",
        ...
        System.out.printf("Z Range of Q5=±90 horizontal configurations: minZ = %.2f, maxZ = %.2f\n", minZ, maxZ);
    }
