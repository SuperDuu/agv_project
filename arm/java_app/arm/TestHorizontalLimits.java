public class TestHorizontalLimits {
    public static void main(String[] args) {
        System.out.println("Searching for Low Pick configs (Z = 85.0, Q1 = 0.0, both horizontal):");
        search(85.0, 20.0, 90.0, 38.0);

        System.out.println("\nSearching for High Place configs (Z = 105.0, Q1 = 0.0, both horizontal):");
        search(105.0, -90.0, -20.0, 65.0);
    }
            ...
            for (double q3 = 20.0; q3 <= 165.0; q3 += 2.0) {
                for (double q4 = -95.0; q4 <= -15.0; q4 += 2.0) {
                    for (double q5 = -90.0; q5 <= 90.0; q5 += 5.0) {
                        for (double q6 = -45.0; q6 <= 45.0; q6 += 5.0) {
