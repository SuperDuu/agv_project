public class FindCenteredConfigs {
    public static void main(String[] args) {
        System.out.println("Searching for Low Pick configs (Z = 75.0 cm, Q1 = 0.0, X >= 38):");
        search(75.0, 20.0, 80.0, 38.0);

        System.out.println("\nSearching for High Place configs (Z = 95.0 cm, Q1 = 0.0, X >= 65):");
