...
public class PrintCorrectCheckPoints {
    public static void main(String[] args) {
        double[] q = { 0.0, -90.0, 139.0, -95.0, 0.0, 30.0 };
        double[][] pts = computeAllJoints3DForAngles(q, true);
        
        System.out.printf("Joint 6: (%.2f, %.2f, %.2f)\n", pts[6][0], pts[6][1], pts[6][2]);
        System.out.printf("TCP: (%.2f, %.2f, %.2f)\n", pts[7][0], pts[7][1], pts[7][2]);
        
        double[] ptMid = { (pts[6][0] + pts[7][0])/2.0, (pts[6][1] + pts[7][1])/2.0, (pts[6][2] + pts[7][2])/2.0 };
        System.out.printf("Midpoint: (%.2f, %.2f, %.2f)\n", ptMid[0], ptMid[1], ptMid[2]);
    }
