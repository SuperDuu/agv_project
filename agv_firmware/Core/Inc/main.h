...
#define WG1_Pin GPIO_PIN_3
#define WG1_GPIO_Port GPIOC
#define WG1_EXTI_IRQn EXTI3_IRQn
#define WG0_Pin GPIO_PIN_0
#define WG0_GPIO_Port GPIOA
#define WG0_EXTI_IRQn EXTI0_IRQn
