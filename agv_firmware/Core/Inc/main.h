...
#define WG1_Pin GPIO_PIN_1
#define WG1_GPIO_Port GPIOF
#define WG1_EXTI_IRQn EXTI1_IRQn
#define B_Out4_Pin GPIO_PIN_2
#define B_Out4_GPIO_Port GPIOF
#define B_Out5_Pin GPIO_PIN_3
#define B_Out5_GPIO_Port GPIOF
#define WG0_Pin GPIO_PIN_4
#define WG0_GPIO_Port GPIOF
#define WG0_EXTI_IRQn EXTI4_IRQn
